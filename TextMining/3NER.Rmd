...
# More patterns.
# original metrics: 0.8 0.003499563 0.006968641
pattern2=c(pattern2,"directed/VBN by/IN ([A-z]*)/NN ([A-z]*)/NN")  # metrics: 0.7777778 0.004593176 0.00913242
pattern2=c(pattern2,"written/VBN by/IN ([A-z]*)/NN ([A-z]*)/NN")   # metrics: 0.8333333 0.004374453 0.00870322
pattern2=c(pattern2,"actor/NN(?: ,/,)? ([A-z]*)/NN ([A-z]*)/NN")   # metrics: 0.8285714 0.006342957 0.01258954
pattern2=c(pattern2,"doctor/NN(?: ,/,)? ([A-z]*)/NN ([A-z]*)/NN")  # metrics: 0.8181818 0.003937008 0.007836308
pattern2=c(pattern2,"lawyer/NN(?: ,/,)? ([A-z]*)/NN ([A-z]*)/NN")  # metrics: 0.8181818 0.003937008 0.007836308
pattern2=c(pattern2,"scientist/NN(?: ,/,)? ([A-z]*)/NN ([A-z]*)/NN")  # metrics: 0.8095238 0.003718285 0.007402569
