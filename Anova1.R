...
## OPTIONAL
## restricting our attention to that variables in lm.1, looking for the best model including two order interactions between the variables X's
